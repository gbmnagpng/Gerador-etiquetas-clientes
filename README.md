...
(If a requirements.txt file is present in the repository, you can run: pip install -r requirements.txt)
...
2. Double-click main.exe (or LabelGenerator.exe).
3. The app will launch directly, with no Python installation required on your machine.
